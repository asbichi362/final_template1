# Generated by Django 3.1.3 on 2023-05-08 15:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Choice_text', models.CharField(default='Choice content', max_length=30)),
                ('is_correct', models.CharField(default='Choice is correct', max_length=30)),
            ],
        ),
        migrations.CreateModel(
            name='Course',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('question_text', models.CharField(default='question_text', max_length=30)),
                ('grade', models.CharField(default='grade', max_length=30)),
